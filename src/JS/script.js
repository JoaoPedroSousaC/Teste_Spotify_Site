...
const baseMusicas = [
    ...
    {
        'name': 'Beethoven Piano Sonata nr15 op28 Pastoral I Allegro ',
        'artist': 'Karine Gilanyan',
        'path': './src/audio/Karine_Gilanyan_-_Beethoven_-_Piano_Sonata_nr15_in_D_major_op28_Pastoral_-_I_Allegro.mp3',
        'album': 'Beethoven\'s Sonata No. 15 in D Major',
    },
    {
        'name': 'Beethoven Piano Sonata nr15 op28 Pastoral II Andante',
        'artist': 'Karine Gilanyan',
        'path': './src/audio/Karine_Gilanyan_-_Beethoven_-_Piano_Sonata_nr15_in_D_major_op28_Pastoral_-_II_Andante.mp3',
        'album': 'Beethoven\'s Sonata No. 15 in D Major',
    },
    {
        'name': 'Didone Abbandonata op50 no3III Allegro',
        'artist': 'Nathan Eckel',
        'path': './src/audio/Nathan_Eckel_-_03_-_Sonata_in_G_Minor_Didone_Abbandonata_op50_no3_-_III_Allegro_agitato_e_con_disperazione.mp3',
        'album': 'Nathan Eckel',
    }
